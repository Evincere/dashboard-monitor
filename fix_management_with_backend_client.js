...
// Crear una nueva versión del archivo usando backendClient
...
fs.writeFileSync('src/app/api/postulations/management/route.ts', newContent);

console.log('✅ Archivo reescrito usando backendClient para cálculo dinámico de progreso');
