...
console.log('Testing corrected token...');
...
try {
  ...
  console.log('Success:', !!parsed.content);
  console.log('Users count:', parsed.content?.length || 0);
  console.log('Total users:', parsed.totalElements);
} catch (error) {
